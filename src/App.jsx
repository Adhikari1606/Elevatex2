...
export default function App() {
  ...
  return (
    <>
          ...
          */}
          ...
          <div className="relative">
            ...
            <div className="max-w-2xl ">
              ...
              <h2 className="text-xl text-gray-700 mb-8 mr-20">
            ...
            <div className="absolute top-0 right-0 h-full w-1/2 bg-green-500 opacity-30 hidden lg:block" style={{ clipPath: 'polygon(10% 0, 100% 0, 100% 100%, 0% 100%)' }}>
            </div>
            ...
            <img src="https://www.shaip.com/wp-content/uploads/2023/02/Blog_Selecting-the-Right-AI-Training-Data-is-Important.jpg" alt="image" className="" />
            </div>
          </div>
        </div>
     ...
     {/*section 2*/}
     <div className="max-w-full mx-auto bg-gray-50 mt-12 ">
          <div className=" max-w-7xl mx-auto px-28 grid grid-cols-1 md:grid-cols-3 gap-16  p-6  ">
            ...
            <div className=" mt-2"><LearningIcon /></div>
              <div>
                <p className="text-sm ml-6 text-gray-600">Learning Format</p>
              ...
              <div className="bg-white p-4 rounded-xl shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className={`w-full py-3 px-4 bg-green-600 text-white font-medium rounded-lg transition-colors ${
                      isSubmitting 
          ...
          <div className="flex items-center gap-8 border-b border-green-200">
            {Object.entries(courseContent).map(([key, content]) => (
              <button
                ...
                className={`text-lg font-semibold pb-4 px-4 relative ${
                  activeTab === key
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <svg
                      className={`w-5 h-5 transform transition-all duration-300 text-grey-600 ${
